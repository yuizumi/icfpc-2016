...
　　　　（引数を）　始点番号と　名付ける
　　　　始点に　１を　足して　頂点数で　割った余りを　終点番号と　名付ける
...
　　　　座標型の　リスト型の　オブジェクトを作成して　折った側の点と　名付ける
　　　　座標型の　リスト型の　オブジェクトを作成して　残った側の点と　名付ける
...
　　　　　　頂点［番号］と　折り線との　位置関係を　頂点位置と　名付ける
　　　　　　頂点位置が　折る側に　等しい　ならば
　　　　　　　　折り線で　頂点［番号］を　折り返す
...
　　　　　　折側の点から　折り紙片の　インスタンスを作成　結果の　折側に　入れる
　　　　残った側の点の　要素数が　３　以上　ならば
　　　　　　残側の点から　折り紙片の　インスタンスを作成　結果の　残側に　入れる
